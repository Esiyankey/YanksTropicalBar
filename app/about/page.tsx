      ...
      <section className="max-w-7xl mx-auto px-6 md:px-16 py-24 grid md:grid-cols-2 gap-20 items-center">
        <div className="">
          ...
          <h2 className="text-4xl md:text-5xl  text-gray-900 mb-8 leading-tight">
            From Humble Roots <br />
            to Royal Tables
          </h2>
          <p className="text-[#b44125] font-semibold text-lg mb-6 italic">
            A journey that began in a family kitchen, now bringing flavor and
            joy across Ghana.
          </p>
          <div className="space-y-6 text-gray-600 leading-relaxed text-md">
            <p>
              ...
              perfect Sobolo—blending the tartness of hibiscus with the warmth
              of ginger—has grown into a trusted catering service bringing
              drinks, fruit juices, and snacks to every occasion.
            </p>
            <p>
              Every drink and setup tells a story. From refreshing asana to
              cooling lamuche, we honor tradition while creating memorable
              moments. Our goal is simple: make every event lively, vibrant, and
              unforgettable.
            </p>
          </div>
        </div>
        ...
        <section className="bg-[#fdf8f6] py-10 text-center px-6">
          <div className="max-w-4xl mx-auto">
            <span className="text-6xl text-[#d98c7a] block mb-4 opacity-50 italic">
              “
            </span>
            <p className="text-3xl md:text-4xl text-gray-700 leading-[1.4] font-light">
              The calabash that brings refreshment speaks louder than words—it
              delivers joy, culture, and flavor in every sip.
            </p>
            <div className="mt-10 flex items-center justify-center gap-4">
              <div className="h-px w-8 bg-[#b44125]"></div>
              <p className="text-xs tracking-[0.3em] text-[#7a2d1a] uppercase font-bold">
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-16 py-24">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
              We honor the time-honored methods of our ancestors. No shortcuts,
              no artificial flavors—only the purest ingredients and the freshest
              Ghanaian produce for an unforgettable experience.
            </p>
          </div>
        </section>
              ...
              <div className="max-w-7xl mx-auto px-6 md:px-16 py-24 grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <div className="space-y-6 text-gray-600 leading-relaxed text-md max-w-lg">
                    <p>
                      We dont just serve drinks; we set the stage. Our signature
                      setups feature hand-carved calabashes, kente-lined table
                      runners, and live garnishing stations that turn
                      refreshment into a performance.
                    </p>
                    <p>
                      Whether its a vibrant traditional engagement or a
                      high-profile corporate gala, we bring the warmth of
                      Ghanaian hospitality to every interaction. Our staff are
                      trained not just in service, but in the stories behind
      ...
      <section className="bg-[#b44125] py-24 text-center px-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-orange-100 max-w-2xl mx-auto mb-12 text-lg font-light">
            Ready to bring a taste of Ghanaian heritage to your next event? Let
            us craft a refreshment experience your guests will never forget.
          </p>
